...
const Trapper_Cat_ViewR = () => {
  ...
  const fetchAllTransaction = () => {
    ...
    setSearchQuery("");
    const url = JSON.parse(localStorage.getItem("AFA_user"))?.role.includes(
      "SuperResTrapper"
    )
      ? `${import.meta.env.VITE_API_URL}/api/v2/rescue/cat/allTrappedCases`
      : `${import.meta.env.VITE_API_URL}/api/v2/rescue/cat/all/${
...
export default Trapper_Cat_ViewR;
