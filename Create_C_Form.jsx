...
const Create_C_Form = () => {
  ...
  const handleSubmit = () => {
    if (
      ...
      setLoading(true);
      const formattedTrapDate = catForm.isOffline ? formatDate(catForm.trapDate) : generateCurrentDate();
      const data = {
      ...
      axios
        .post(
          ...
          }/api/v2/transaction/sterilization/cat/create`,
          JSON.stringify(data),
          {
            headers: {
