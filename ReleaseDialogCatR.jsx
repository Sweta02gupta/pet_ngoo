  ...
  const handleSubmit = () => {
    if (modifiedStatus.newStatus === "" || !imgSrc) {
      ...
      if (modifierType === "trapper") {
        ...
        axios
          .put(
            `${import.meta.env.VITE_API_URL}/api/v2/rescue/cat/update/release/${
        ...
        axios
          .put(
            ...
            }/api/v2/rescue/cat/update/transactionStatus/${
              currentModification.id
            }`,
            JSON.stringify(data),
            {
               ...
               {statusList
                 .filter(
                   (status) =>
                     ...
                     status.StatusName.toLowerCase() !== "trapped" // Exclude "trapped" status
                 )
                 .sort((a, b) => {
...
export default ReleaseDialogCatR;
