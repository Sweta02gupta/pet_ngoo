  ...
  const handleSubmit = () => {
    if (modifiedStatus.newStatus === "" || !imgSrc) {
      ...
      if (modifierType === "trapper") {
        ...
        axios
          .put(
            `${import.meta.env.VITE_API_URL}/api/v2/rescue/dog/update/release/${
        ...
        axios
          .put(
            ...
            }/api/v2/rescue/dog/update/transactionStatus/${
              currentModification.id
            }`,
            JSON.stringify(data),
            {
            ...
            <div className="w-full px-10 flex flex-col justify-center items-center gap-3">
              {modifierType === "admin" ? (
                ...
                >
                  {statusList
                    .filter(
                      (status) => status.id !== currentModification.StatusId
                    )
                    .sort((a, b) => {
...
export default ReleaseDialogDogR;
