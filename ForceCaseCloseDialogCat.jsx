...
const ForceCaseCloseDialogCat = ({
  ...
  const handleSubmit = (isSurgeryRelease = true) => {
    ...
    let data = {
      afaStatusId: statusList.filter((s) => s.StatusName === "released")[0].id,
    ...
    // Additional logic for release without surgery
    if (!isSurgeryRelease) {
      data = {
        ...data,
        caseClosed: true, // Indicate the case is also being closed
      };
    }
    ...
    axios
      .put(
        ...
        }/api/v2/transaction/sterilization/cat/update/forceRelease/${
...
export default ForceCaseCloseDialogCat;
