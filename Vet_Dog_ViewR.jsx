...
//import SurgeryDialog from "../../../../components/Dialog/SurgeryDialog";
import SurgeryDialogDogR from "../../../../components/Dialog/SurgeryDialogDogR";
  ...
  const fetchAllTransaction = () => {
    ...
    axios
      .get(
        ...
        // }`,
        `${import.meta.env.VITE_API_URL}/api/v2/rescue/dog/vet/${
          JSON.parse(localStorage.getItem("AFA_user")).userId
        }`,
        {
          headers: {
