...
//import ForceCaseCloseDialogCat from "../../../../components/Dialog/";
  ...
  const fetchAllTransaction = () => {
    ...
    axios
      .get(
        ...
        }/api/v2/transaction/sterilization/cat/all`,
        {
          headers: {
  ...
  const updateComments = () => {
    ...
    axios
      .put(
        `${
          import.meta.env.VITE_API_URL
        }/api/v2/transaction/sterilization/cat/update/${
            ...
            <ReleaseDialogCat
              statusList={statusList.filter(
                (s) =>
                  ...
                  s.StatusName === "surgery" ||
                  s.StatusName === "sick" ||
                  s.StatusName === "deceased"  ||
                  s.StatusName === "release without surgery"
              )}
