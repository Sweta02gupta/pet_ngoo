...
const Trapper_Dog_ViewR = () => {
  ...
  const fetchAllTransaction = () => {
    ...
    const url = JSON.parse(localStorage.getItem("AFA_user"))?.role.includes(
      ...
      ? `${import.meta.env.VITE_API_URL}/api/v2/rescue/dog/allTrappedCases`
      : `${import.meta.env.VITE_API_URL}/api/v2/rescue/dog/all/${
...
export default Trapper_Dog_ViewR;
